...
export class FindingsService {
  ...
  updateFilters(search_filter,categories_search_filter): Observable<any>{
    let url: string = this.apiRoot+"/filter";
  ...
  updateTable(search_filter,categories_search_filter,page): Observable<any>{
    let url: string = this.apiRoot+"/table";
    let params = new HttpParams({ fromObject: search_filter });
    let organ_list: string[]=[];
    let observation_list: string[]=[];
    let grade_list: string[]=[];
