  ...
  ngOnInit(){
    ...
    this.findService.currentTable.subscribe(table_info =>{
      ...
      if (!this.firstTime){
        ...
        this.plots['Findings'].labels =  ['Total Findings', 'Findings Selected']
        this.plots['Species'].labels = this.plot_info['normalised_species'][0]
        this.plots['Route'].labels = this.plot_info['normalised_administration_route'][0]
        ...
        setTimeout(() => {
          ...
          this.plots['Route'].data = this.plot_info['normalised_administration_route'][1]
    ...
    a.labels =  ['Structures', 'Structures Selected']
    a.chartType = 'pie'
    a.title= "Structures"
    ...
    a.labels = ['Total Studies', 'Studies Selected']
    a.chartType = 'pie'
    a.title= "Studies"
    ...
    a.labels = ['Total Findings', 'Findings Selected']
    a.chartType = 'pie'
    a.title= "Findings"
    ...
    a.id=this.plotID;
    this.plotID++;
    a.data = this.plot_info['normalised_administration_route'][1]
    a.labels = this.plot_info['normalised_administration_route'][0]
    a.title= "Administration route"
    a.chartType = 'pie'
    this.plots['Route']=a
